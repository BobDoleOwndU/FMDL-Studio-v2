Shader "FoxShaders/fox3DDF_ParallaxOcclusion_LNM_VR"
{
	Properties
	{
		MatParamIndex_0("MatParamIndex_0", Vector) = (0.0, 0.0, 0.0, 0.0)
		HeightScale("HeightScale", Vector) = (0.0, 0.0, 0.0, 0.0)
		OccSampleMin("OccSampleMin", Vector) = (0.0, 0.0, 0.0, 0.0)
		OccSampleMax("OccSampleMax", Vector) = (0.0, 0.0, 0.0, 0.0)
		...
		Height_Tex_LIN("Height_Tex_LIN", 2D) = "white" {}
	}
