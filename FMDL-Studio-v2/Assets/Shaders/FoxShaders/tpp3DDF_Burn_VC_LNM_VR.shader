...
Properties {
	...
	BurningBlend("BurningBlend", Vector) = (0.0, 0.0, 0.0, 0.0)
	Add_Roughness("Add_Roughness", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	BurningMap_Tex_SRGB("BurningMap_Tex_SRGB", 2D) = "white" {}
	CharcoalMap_Tex_SRGB("CharcoalMap_Tex_SRGB", 2D) = "white" {}
