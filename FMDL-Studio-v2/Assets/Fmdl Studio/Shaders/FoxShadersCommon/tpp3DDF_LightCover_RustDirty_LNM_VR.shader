Shader "FoxShaders/tpp3DDF_LightCover_RustDirty_LNM_VR" {
Properties {
	...
	_InternalNormalMap_Tex_NRM("InternalNormalMap_Tex_NRM", 2D) = "white" {}
	_CoverTranslucentMap_Tex_LIN("CoverTranslucentMap_Tex_LIN", 2D) = "white" {}
