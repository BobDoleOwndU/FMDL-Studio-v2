Shader "FoxShaders/fox3DDF_Blin_Incidence_LayerMul_Tension_3MT_Dirty_LNM_VR" {
Properties {
	...
	_TensionRate("TensionRate", Vector) = (0.0, 0.0, 0.0, 0.0)
	_TensionShift("TensionShift", Vector) = (0.0, 0.0, 0.0, 0.0)
	_TensionController("TensionController", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_TensionSubNormalMap_Tex_NRM("TensionSubNormalMap_Tex_NRM", 2D) = "white" {}
