Shader "FoxShaders/tpp3DDF_Burn_VC_LNM_VR" {
Properties {
	...
	_BurningBlend("BurningBlend", Vector) = (0.0, 0.0, 0.0, 0.0)
	_Add_Roughness("Add_Roughness", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_BurningMap_Tex_SRGB("BurningMap_Tex_SRGB", 2D) = "white" {}
	_CharcoalMap_Tex_SRGB("CharcoalMap_Tex_SRGB", 2D) = "white" {}
