Shader "FoxShaders/fox3DDF_Blin_LayerSRGBBl_2SubNorm_NrmUV_LNM_VR" {
Properties {
	...
	_SmallSubNormal_Blend("SmallSubNormal_Blend", Vector) = (0.0, 0.0, 0.0, 0.0)
	_URepeat_SmallSubNorm_UV("URepeat_SmallSubNorm_UV", Vector) = (0.0, 0.0, 0.0, 0.0)
	_VRepeat_SmallSubNorm_UV("VRepeat_SmallSubNorm_UV", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_SmallSubNormalMap_Tex_NRM("SmallSubNormalMap_Tex_NRM", 2D) = "white" {}
