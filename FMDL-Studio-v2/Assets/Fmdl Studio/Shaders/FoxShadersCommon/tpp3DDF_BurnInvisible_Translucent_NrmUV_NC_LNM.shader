Shader "FoxShaders/tpp3DDF_BurnInvisible_Translucent_NrmUV_NC_LNM" {
Properties {
	_MatParamIndex_0("MatParamIndex_0", Vector) = (0.0, 0.0, 0.0, 0.0)
	_BurnColor("BurnColor", Vector) = (0.0, 0.0, 0.0, 0.0)
	_AlphaMax("AlphaMax", Vector) = (0.0, 0.0, 0.0, 0.0)
	_UShift_UV("UShift_UV", Vector) = (0.0, 0.0, 0.0, 0.0)
	_VShift_UV("VShift_UV", Vector) = (0.0, 0.0, 0.0, 0.0)
	_UShiftBL_UV("UShiftBL_UV", Vector) = (0.0, 0.0, 0.0, 0.0)
	_VShiftBL_UV("VShiftBL_UV", Vector) = (0.0, 0.0, 0.0, 0.0)
	_MaskColorAdd("MaskColorAdd", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_BurnPattern_Tex_LIN("BurnPattern_Tex_LIN", 2D) = "white" {}
