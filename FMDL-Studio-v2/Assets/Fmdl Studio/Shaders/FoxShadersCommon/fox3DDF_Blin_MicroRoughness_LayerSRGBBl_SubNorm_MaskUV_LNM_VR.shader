Shader "FoxShaders/fox3DDF_Blin_MicroRoughness_LayerSRGBBl_SubNorm_MaskUV_LNM_VR" {
Properties {
	...
	_MinRoughness("MinRoughness", Vector) = (0.0, 0.0, 0.0, 0.0)
	_RoughnessFrequency("RoughnessFrequency", Vector) = (0.0, 0.0, 0.0, 0.0)
