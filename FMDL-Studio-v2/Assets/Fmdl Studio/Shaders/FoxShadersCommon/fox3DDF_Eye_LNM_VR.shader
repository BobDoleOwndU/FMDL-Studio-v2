Shader "FoxShaders/fox3DDF_Eye_LNM_VR" {
Properties {
	...
	_ViewReflection_Tex_LIN("ViewReflection_Tex_LIN", 2D) = "white" {}
	_LensHeight_Tex_LIN("LensHeight_Tex_LIN", 2D) = "white" {}
	_Base_Tex2_SRGB("Base_Tex2_SRGB", 2D) = "white" {}
