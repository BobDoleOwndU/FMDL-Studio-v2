Shader "FoxShaders/pes3DDC_Puddle_GGX_LNM_VR" {
Properties {
	_MatParamIndex_0("MatParamIndex_0", Vector) = (0.0, 0.0, 0.0, 0.0)
	_PuddleSpeed1U("PuddleSpeed1U", Vector) = (0.0, 0.0, 0.0, 0.0)
	_PuddleSpeed1V("PuddleSpeed1V", Vector) = (0.0, 0.0, 0.0, 0.0)
	_PuddleSpeed2U("PuddleSpeed2U", Vector) = (0.0, 0.0, 0.0, 0.0)
	_PuddleSpeed2V("PuddleSpeed2V", Vector) = (0.0, 0.0, 0.0, 0.0)
	_PuddleCurTime("PuddleCurTime", Vector) = (0.0, 0.0, 0.0, 0.0)
