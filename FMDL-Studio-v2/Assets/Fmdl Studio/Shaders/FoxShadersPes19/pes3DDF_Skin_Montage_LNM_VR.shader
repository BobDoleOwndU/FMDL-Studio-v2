Shader "FoxShaders/pes3DDF_Skin_Montage_LNM_VR" {
Properties {
	_MatParamIndex_0("MatParamIndex_0", Vector) = (0.0, 0.0, 0.0, 0.0)
	_Wrinkle3("Wrinkle3", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_Wrinkle1("Wrinkle1", Vector) = (0.0, 0.0, 0.0, 0.0)
	_Wrinkle2("Wrinkle2", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_NormalMap_Animation_Tex_NRM("NormalMap_Animation_Tex_NRM", 2D) = "white" {}
	_Wrinkle_Mask_LIN("Wrinkle_Mask_LIN", 2D) = "white" {}
