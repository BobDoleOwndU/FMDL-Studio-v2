Shader "FoxShaders/pes3DDF_Crowd_LNM_VR" {
Properties {
	_MatParamIndex_0("MatParamIndex_0", Vector) = (0.0, 0.0, 0.0, 0.0)
	_ModelId("ModelId", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_IsNationalFlag("IsNationalFlag", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_FaceTex_SRGB("FaceTex_SRGB", 2D) = "white" {}
	_PartsTex_SRGB("PartsTex_SRGB", 2D) = "white" {}
	_ColorTex_SRGB("ColorTex_SRGB", 2D) = "white" {}
