Shader "FoxShaders/pes3DDF_Hair2_NrmUV_NC_LNM_VR" {
Properties {
	_MatParamIndex_0("MatParamIndex_0", Vector) = (0.0, 0.0, 0.0, 0.0)
	_SpecularCubeScale("SpecularCubeScale", Vector) = (0.0, 0.0, 0.0, 0.0)
	_AlbedoCubeScale("AlbedoCubeScale", Vector) = (0.0, 0.0, 0.0, 0.0)
	_CubeAttenuation("CubeAttenuation", Vector) = (0.0, 0.0, 0.0, 0.0)
	_Incidence_Color("Incidence_Color", Vector) = (0.0, 0.0, 0.0, 0.0)
	_HeadPosition("HeadPosition", Vector) = (0.0, 0.0, 0.0, 0.0)
	_Incidence_Roughness("Incidence_Roughness", Vector) = (0.0, 0.0, 0.0, 0.0)
	_HairColor("HairColor", Vector) = (0.0, 0.0, 0.0, 0.0)
	_HairColor_Screen("HairColor_Screen", Vector) = (0.0, 0.0, 0.0, 0.0)
	_HairColor_Multiply("HairColor_Multiply", Vector) = (0.0, 0.0, 0.0, 0.0)
	_Velocity("Velocity", Vector) = (0.0, 0.0, 0.0, 0.0)
	_PreviousVelocity("PreviousVelocity", Vector) = (0.0, 0.0, 0.0, 0.0)
