Shader "FoxShaders/fox3DDF_GGX_TexAnim_NC_LNM_VR" {
Properties {
	_MatParamIndex_0("MatParamIndex_0", Vector) = (0.0, 0.0, 0.0, 0.0)
	_PositionBase("PositionBase", Vector) = (0.0, 0.0, 0.0, 0.0)
	_PositionScale("PositionScale", Vector) = (0.0, 0.0, 0.0, 0.0)
	_AnimeFPS("AnimeFPS", Vector) = (0.0, 0.0, 0.0, 0.0)
	_AnimeDuration("AnimeDuration", Vector) = (0.0, 0.0, 0.0, 0.0)
	_AnimeOffset("AnimeOffset", Vector) = (0.0, 0.0, 0.0, 0.0)
	_Position_Tex_LIN("Position_Tex_LIN", 2D) = "white" {}
	_Rotation_Tex_LIN("Rotation_Tex_LIN", 2D) = "white" {}
	...
	_MetalnessMap_Tex_LIN("MetalnessMap_Tex_LIN", 2D) = "white" {}
