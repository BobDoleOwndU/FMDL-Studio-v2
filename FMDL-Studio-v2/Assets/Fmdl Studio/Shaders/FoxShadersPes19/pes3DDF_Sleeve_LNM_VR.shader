Shader "FoxShaders/pes3DDF_Sleeve_LNM_VR" {
Properties {
	...
	_BadgeMatrix2("BadgeMatrix2", Vector) = (0.0, 0.0, 0.0, 0.0)
	_BadgeMatrix3("BadgeMatrix3", Vector) = (0.0, 0.0, 0.0, 0.0)
	...
	_Badge_Tex_LIN("Badge_Tex_LIN", 2D) = "white" {}
